Rails.application.routes.draw do
  ...
  get "/course_signup" => redirect("http://learn.jigsawlabs.co/account/finish_auth?course_id=course-v1:course-v1:masters+5+2019&enrollment_action=enroll&email_opt_in=false"), :as => :course_signup
