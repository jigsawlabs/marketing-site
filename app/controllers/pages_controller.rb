class PagesController < ApplicationController
  ...
  def free
    ...
    neural_links = ["0-intro-ml/0-ml-problem", "0-intro-ml/1-ml-process", "1-hypothesis-fn-neuron/1-single-neurons/0-intro-to-neural-networks",
                     ...
                     "2-layers/0-summations-and-dot-products", "2-layers/1-multiple-neurons", "2-layers/2-building-a-layer", "2-layers/4-building-layers",
    ...
    neural_titles = ["Introduction", "The Process", "Neural Networks", "Perceptrons", "Plotting Perceptrons",
                      "Sigmoid Neuron", "Sigmoid Neuron Lab", "Dot Products", "Multiple Neurons", "Building a Layer Lab", "Building Layers",
